...
| Bot (fallback) | `C:\path\to\heatherbot\logs\heather_bot.log` | When started without --log-dir |
| TTS | `C:\path\to\heatherbot\logs\tts.log` | Voice note generation |
